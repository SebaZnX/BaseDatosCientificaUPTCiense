                ...
                case 1:
                    ...
                    if ((opCase1 < 1) || (opCase1 > 3)) {
                        JOptionPane.showMessageDialog(null,
                                "La opcion no esta disponible, intente de nuevo");
                    } else {
                        ...
                        switch (opCase1) {
                            case 1:
                                tituloDocumentoAcademico = JOptionPane.showInputDialog
                                        ("Ingrese el titulo del articulo cientifico");
                                inicialesyApellidosAutor = JOptionPane.showInputDialog
                                        ("Ingrese las iniciales y apellidos del articulo cientifico");
                                String tituloRevista = JOptionPane.showInputDialog
                                        ("Ingrese el titulo de la revista abreviado");
                                String volumen = JOptionPane.showInputDialog
                                        ("Ingrese el volumen del articulo cientifico");
                                String numero = JOptionPane.showInputDialog
                                        ("Ingrese el numero del articulo cientifico");
                                String paginas = JOptionPane.showInputDialog
                                        ("Ingrese las paginas del articulo cientifico");
                                String mes = JOptionPane.showInputDialog
                                        ("Ingrese el mes del articulo cientifico");
                                anhoPubliacion = JOptionPane.showInputDialog
                                        ("Ingrese el año de publicacion del articulo cientifico");
                                ...
                                if (creado) {
                                    JOptionPane.showMessageDialog(null,
                                            "Articulo cienfico creado");
                                } else {
                                    JOptionPane.showMessageDialog(null,
                                            "Articulo cienfico no fue creado");
                                }
                                break;
                            case 2:
                                tituloDocumentoAcademico = JOptionPane.showInputDialog
                                ...
                                inicialesyApellidosAutor = JOptionPane.showInputDialog
                                        ("Ingrese las iniciales y apellidos del autor del libro");
                                String edicion = JOptionPane.showInputDialog
                                        ("Ingrese la edicion del libro");
                                String lugarPublicacion = JOptionPane.showInputDialog
                                        ("Ingrese el lugar de la publicacion del libro");
                                ...
                                if (creado) {
                                    JOptionPane.showMessageDialog(null,
                                            "Libro academico creado");
                                } else {
                                    JOptionPane.showMessageDialog(null,
                                            "Libro academico no fue creado");
                                }
                                break;
                            case 3:
                                tituloDocumentoAcademico = JOptionPane.showInputDialog
                                        ("Ingrese el titulo de la memoria de la conferencia");
                                inicialesyApellidosAutor = JOptionPane.showInputDialog
                                        ("Ingrese las iniciales y apellidos de la memoria de la conferencia");
                                String nombreCompletoConferencia = JOptionPane.showInputDialog
                                        ("Ingrese el nombre completo de la memoria de la conferencia");
                                String ciudadConferencia = JOptionPane.showInputDialog
                                        ("Ingrese la ciudad de la memoria de la conferencia");
                                String estadoConferencia = JOptionPane.showInputDialog
                                        ("Ingrese el estado de la memoria de la conferencia");
                                String paginasConferencia = JOptionPane.showInputDialog
                                        ("Ingrese las paginas de la memoria de la conferencia");
                                anhoPubliacion = JOptionPane.showInputDialog
                                        ("Ingrese el año de la memoria de la conferencia ");
                ...
                case 3:
                    ...
                    if (encontradoIdActualizar) {
                        ...
                        switch (opHashMapModificar) {
                            case 1:
                                JOptionPane.showMessageDialog(null,
                                        "ACTUALIZACION DE UN ARTICULO CIENTIFICO\n INGRESE LOS SIGUIENTES DATOS");
                                tituloDocumentoAcademico = JOptionPane.showInputDialog
                                        ("Ingrese el titulo del articulo cientifico");
                                inicialesyApellidosAutor = JOptionPane.showInputDialog
                                        ("Ingrese las iniciales y apellidos del articulo cientifico");
                                ...
                                modificado = gestionSistema.actualizarInfoArticuloInvestigacion(idBuscarActualizacion,
                                        tituloDocumentoAcademico, anhoPubliacion, inicialesyApellidosAutor,
                                        tituloRevista, volumen, numero,
                                        paginas, mes);
                                if (modificado) {
                                    JOptionPane.showMessageDialog(null,
                                            "Articulo cientifico actualizado");
                                } else {
                                    JOptionPane.showMessageDialog(null,
                                            "Articulo cientifico no modificado");
                                }
                                break;
                            case 2:
                                JOptionPane.showMessageDialog(null,
                                        "ACTUALIZACION DE UN LIBRO ACADEMICO\n INGRESE LOS SIGUIENTES DATOS");
                                tituloDocumentoAcademico = JOptionPane.showInputDialog
                                        ("Ingrese el titulo del libro");
                                inicialesyApellidosAutor = JOptionPane.showInputDialog
                                        ("Ingrese las iniciales y apellidos del autor del libro");
                                ...
                                modificado = gestionSistema.actualizarInfoLibrosAcademico(idBuscarActualizacion,
                                        tituloDocumentoAcademico, anhoPubliacion,
                                        inicialesyApellidosAutor, edicion, lugarPublicacion, editorial);
                                if (modificado) {
                                    JOptionPane.showMessageDialog(null,
                                            "Libro academico actualizado");
                                } else {
                                    JOptionPane.showMessageDialog(null,
                                            "Libro academico no modificado");
                                }
                                break;
                            case 3:
                                JOptionPane.showMessageDialog(null,
                                        "ACTUALIZACION DE UN MEMORIAS DE CONFERENCIA\n " +
                                                "INGRESE LOS SIGUIENTES DATOS");
                                tituloDocumentoAcademico = JOptionPane.showInputDialog
                                        ("Ingrese el titulo de la memoria de la conferencia");
                                inicialesyApellidosAutor = JOptionPane.showInputDialog
                                ...
                                modificado = gestionSistema.actualizarMemoriaConferencia(idBuscarActualizacion,
                                        tituloDocumentoAcademico, anhoPubliacion, inicialesyApellidosAutor,
                                        nombreCompletoConferencia, ciudadConferencia, estadoConferencia,
                                        paginasConferencia);
                                if (modificado) {
                                    JOptionPane.showMessageDialog(null,
                                            "Memorias de conferencia actualizado");
                                } else {
                                    JOptionPane.showMessageDialog(null,
                                            "Memorias de conferencia no modificado");
                                }
                                break;
                            default:
                                break;
                ...
                case 4:
                    ...
                    if (existeIdEliminar) {
                        ...
                        if (fueEliminado) {
                            ...
                            JOptionPane.showMessageDialog(null,
                                    "No fue posible eliminar el documento academico");
                        }
                    } else {
